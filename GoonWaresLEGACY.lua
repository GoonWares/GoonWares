...
Fluent = loadstring(game:HttpGet("https://github.com/StyearX/Fluent-modded/releases/download/1.4.6/FluentPro"))()
...
SecNextbotESP = Tabs.Main:AddCollapsibleSection('<font color="#FF0000">Nextbot ESP</font>', "solar/danger-triangle-bold", false)
...
SecSurvivorESP = Tabs.Main:AddCollapsibleSection('<font color="#00AAFF">Survivor ESP</font>', "solar/user-bold", false)
...
Tabs.Main:AddSpace({ Height = 20 })
SecDownedESP = Tabs.Main:AddCollapsibleSection('<font color="#00FF00">Downed Player ESP</font>', "solar/heart-broken-bold", false)
...
SecNextbotModification = Tabs.Nextbots:AddSection("Nextbot Modification", "solar/danger-triangle-bold")
...
function GetThemeAccentColor()
    local Gradients = getgenv().ButtonGradients
...
function BuildTimerDisplay()
    ...
    TimerGradientStroke.Color = getgenv().ButtonGradients.Stroke
...
SecShaderExtension = Tabs.Extension:AddSection("Shader Extension", "solar/filters-bold")
SecShaderExtension:AddSpace({ Height = 20 })
SecShaderExtension:AddDivider()
